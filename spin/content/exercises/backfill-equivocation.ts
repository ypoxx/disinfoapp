    ...
    options: [
      {
        ...
        en: 'I ask him to fix what "independent" means, then assess the study under that one meaning only: organisationally separate is not the same as interest-free. As long as the commission and funding come from the manufacturer, we cite it at most with exactly that caveat — or not at all.',
      },
      {
