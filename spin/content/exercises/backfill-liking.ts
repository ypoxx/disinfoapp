...
export const backfillLiking: Exercise[] = [
  ...
  },
  {
    ...
    options: [
      ...
      {
        de: 'Da wir uns so gut verstehen, verzichte ich auf die juristische Prüfung und vertraue seiner Einordnung, dass eine Zwölf-Monats-Frist branchenüblich ist.',
        en: 'Since we get along so well, I skip the legal review and trust his assessment that a twelve-month term is standard in the industry.',
      },
    ],
    correctAnswers: [0],
    explanation: {
      de: 'Der Vertriebsleiter aktiviert Sympathie: Lob und geteilte Erinnerungen erzeugen Wohlwollen, und genau auf dieser warmen Welle reitet die teure Klausel herein — der Handschlag soll die Prüfung ersetzen. Wirksam ist das, weil ein gutes Gefühl zur Person unbemerkt auf die Sachentscheidung abfärbt. Nutze den echten Kern professionell: Eine belastbare, warme Geschäftsbeziehung ist ein Aktivposten — kurze Wege, ehrliches Feedback, Verlässlichkeit. Halte dafür bewusst zwei Konten getrennt, „Beziehung" und „Vertrag": Auf dem Vertragskonto zählen nur eure Standardkriterien, und dort prüfst du die Zwölf-Monats-Frist hart, ganz ohne die Beziehung aufzukündigen. Option zwei fällt genau auf den Hebel herein, indem sie Zuneigung als Beleg für ein gutes Angebot nimmt; „er ist auf unserer Seite" ist ein Gefühl, kein Vertragswert. Betont kühl und misstrauisch zu werden überkorrigiert: Du verschenkst eine tragfähige Beziehung und verhandelst schlechter, denn Sympathie ist an sich kein Angriff, den man abwehren muss. Auf die Prüfung ganz zu verzichten verwechselt Sympathie mit Kompetenz — das wäre der Halo-Effekt, bei dem ein positiver Gesamteindruck auf unverbundene Urteile wie „branchenüblich" durchschlägt.',
      en: 'The sales director activates liking: praise and shared memories create goodwill, and the expensive clause rides in on exactly that warm wave — the handshake is meant to replace the check. It works because a good feeling about the person bleeds unnoticed into the substantive decision. Use the genuine core professionally: a solid, warm business relationship is an asset — quick access, honest feedback, reliability. To protect it, keep two accounts deliberately apart, "relationship" and "contract": on the contract account only your standard criteria count, and there you scrutinise the twelve-month term hard, without ever cancelling the relationship. Option two falls squarely for the lever by treating affection as evidence of a good offer; "he is on our side" is a feeling, not a contract term. Turning pointedly cool and suspicious over-corrects: you throw away a workable relationship and negotiate worse, because liking as such is not an attack to be repelled. Skipping the review altogether confuses liking with competence — that would be the halo effect, where one positive overall impression carries into unrelated judgements like "standard in the industry".',
    },
    points: 10,
    primaryTechniqueId: 'liking',
    relatedTechniques: ['liking', 'halo_effect'],
  },
  {
    ...
    options: [
      ...
      {
        de: 'sein bloßes häufiges Auftauchen ihn dir ohne jeden Inhalt vertrauter und dadurch angenehmer macht (Mere-Exposure-Effekt)',
        en: 'his mere frequent presence makes him more familiar and thus more pleasant to you, without any content at all (mere-exposure effect)',
      },
      {
