...
export const backfillStrawMan: Exercise[] = [
  {
    ...
    correctAnswers: [0],
    explanation: {
      de: 'Strohmann: Der Bereichsleiter ersetzt die tatsächliche Position — zwei Homeoffice-Tage für drei Rollen — durch eine überzeichnete Karikatur („Büro abschaffen", „jeder macht, was er will") und widerlegt dann diese Karikatur statt des echten Vorschlags. Der Mechanismus wirkt, weil die aufgeblasene Extremversion leichter anzugreifen ist als die maßvolle Originalposition, das Publikum die Zuspitzung aber unbewusst der Antragstellerin zurechnet. Der ehrliche Gegenzug zum Strohmann ist das Steelmanning: Du gibst die Gegenposition in ihrer stärksten, wohlwollendsten Lesart wieder, bevor du sie prüfst — wer so argumentiert, gewinnt Vertrauen, statt es zu verspielen. Woran du es erkennst: Der Bereichsleiter widerlegt minutenlang ein „Unternehmen ganz ohne Präsenz", das niemand gefordert hat. Wer entschärfen will, weigert sich, die Karikatur zu übernehmen, und bittet ihn, seinen Einwand am konkreten Antrag festzumachen — zwei feste Tage, drei ortsunabhängige Rollen; sobald er das tut, fällt die Extremversion in sich zusammen. Ein Dammbruch-Argument würde den maßvollen Vorschlag akzeptieren, aber eine unbelegte Kettenreaktion ins Extrem behaupten („erst zwei Tage, dann steht das Büro bald ganz leer") — hier wird die Position aber von Anfang an verzerrt wiedergegeben, nicht ihre Folgekette. Ein Red Herring würde ein sachfremdes Nebenthema einführen, statt die Position selbst zu entstellen. Ein falsches Dilemma würde bloß zwei Optionen behaupten („entweder volle Präsenz oder Chaos") — der Kern ist hier jedoch die verzerrte Wiedergabe des Vorschlags, nicht die künstliche Zweiteilung.',
      en: 'Straw man: the division head replaces the actual position — two work-from-home days for three roles — with an inflated caricature ("abolish the office", "everyone does whatever they like") and then refutes that caricature instead of the real proposal. The mechanism works because the inflated extreme is easier to attack than the measured original, while the audience unconsciously credits the exaggeration to the person who proposed it. The honest opposite of a straw man is steelmanning: you restate the opposing view in its strongest, most charitable form before you test it — argue that way and you earn trust instead of squandering it. How to spot it: the division head spends minutes refuting a "company with no on-site presence" that nobody called for. To defuse it, refuse to adopt the caricature and ask him to pin his objection to the concrete proposal — two fixed days, three location-independent roles; the moment he does, the extreme version collapses. A slippery-slope argument would accept the measured proposal but assert an unproven chain reaction toward the extreme ("first two days, then the office soon stands empty") — here, though, the position is distorted from the outset, not its downstream chain. A red herring would introduce an irrelevant side topic rather than warp the position itself. A false dichotomy would merely assert two options ("either full presence or chaos") — but the core here is the distorted rendering of the proposal, not an artificial split.',
    },
    points: 10,
