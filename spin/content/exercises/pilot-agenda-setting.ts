...
export const pilotAgendaSetting: Exercise[] = [
  {
    ...
    scenario: {
      ...
      en: 'You are analysing media coverage for a client ahead of collective bargaining talks: for weeks, the employers\' association has been placing studies, interviews, and op-eds on production costs in regional and trade media. The individual pieces are soberly written — but the topic dominates the headlines, and in surveys employees now name production costs as the industry\'s most pressing problem.',
    },
    options: [
