...
export const pilotAvailabilityHeuristic: Exercise[] = [
  ...
  },
  {
    ...
    scenario: {
      de: 'Du leitest die Unternehmenskommunikation eines Lebensmittelherstellers. Ein Wettbewerber steckt seit Tagen in einem breit berichteten Rückruf. Für eure ohnehin geplante Pressemitteilung zur Produktsicherheit schlägt der Vertriebsleiter vor: "Ruf die Rückruf-Bilder auf und positioniere uns als die Sicheren — solange die Sache präsent ist, glaubt jeder, dass so etwas ständig passiert. Dieses Fenster müssen wir nutzen." Tatsächlich sind Rückrufe dieser Art in der Branche sehr selten.',
      en: 'You head corporate communications at a food manufacturer. A competitor has been stuck in a widely covered product recall for days. For your already-planned press release on product safety, the sales director suggests: "Play up the recall images and position us as the safe ones — as long as it\'s fresh in people\'s minds, everyone believes this happens all the time. We have to use this window." In fact, recalls of this kind are very rare in the industry.',
    },
    options: [
      {
