...
export const pilotConfirmationBias: Exercise[] = [
  ...
  },
  {
    ...
    correctAnswers: [1],
    explanation: {
      de: 'Die Randnotizen zeigen den Bestätigungsfehler bei der Arbeit: Die eigene Überzeugung ("meine Positionierung trägt") verteilt die Prüfstrenge asymmetrisch — Zustimmung wird exzerpiert, Kritik wegerklärt, ganz ohne Täuschungsabsicht. Der Hebel wirkt, weil sich die Verzerrung wie Sorgfalt anfühlt: Jeder einzelne Einwand gegen ein kritisches Zitat mag berechtigt sein, nur wird er eben nie an die zustimmenden angelegt. Professionell einsetzen lässt sich hier die Gegenrichtung: Falsifikationskriterien vorab festlegen ("Was müsste im Protokoll stehen, damit ich meine Empfehlung ändere?"), symmetrische Auswertung, vier Augen — für die eigene Überzeugung werben ist legitim, wenn die Datenauswertung dagegen abgesichert ist. Erkennen und kontern: asymmetrische Randnotizen sind genau das Warnsignal, das du hier selbst bemerkt hast. Der Verweis auf die eigene Themennähe wirkt plausibel, weil Nähe echte Expertise ist — aber Nähe plus eigenes Investment ist exakt die Bedingung, unter der der Bias am stärksten wirkt; Expertise schützt nicht davor. Die kritischen Zitate nur in den Anhang zu nehmen verwechselt Dokumentation mit Auswertung: Zitate im Anhang heilen nicht, dass die Empfehlung auf verzerrt gewichteten Daten steht — wer liest schon den Anhang gegen die Vorlage. Die Auswertung komplett an die Agentur abzugeben überkorrigiert: Involviertheit erfordert Absicherungsverfahren, nicht den Rückzug — sonst dürfte niemand auswerten, der eine Hypothese hat.',
      en: 'The margin notes show confirmation bias at work: your own conviction ("my positioning holds") distributes scrutiny asymmetrically — approval gets excerpted, criticism gets explained away, with no intent to deceive. The lever works because the distortion feels like diligence: every single objection to a critical quote may be justified — it just never gets applied to the approving ones. What you can deploy professionally is the reverse gear: prespecify falsification criteria ("what would the transcript have to say for me to change my recommendation?"), analyse symmetrically, add a second pair of eyes — advocating for your own conviction is legitimate when the data analysis is safeguarded against it. To recognise and counter it: asymmetric margin notes are exactly the warning signal you caught here yourself. Falling back on your own closeness to the topic sounds plausible because closeness is real expertise — but closeness plus personal stake is precisely the condition under which the bias is strongest; expertise does not immunise. Moving the critical quotes to the appendix confuses documentation with analysis: quotes in an appendix do not repair a recommendation built on skewed weighting — nobody reads the appendix against the paper. Handing the entire analysis to the agency overcorrects: involvement calls for safeguards, not withdrawal — otherwise nobody with a hypothesis could ever analyse data.',
    },
    points: 10,
    primaryTechniqueId: 'confirmation_bias',
