...
export const pilotLossAversion: Exercise[] = [
  ...
  },
  {
    ...
    scenario: {
      de: 'Mitglieder-Newsletter eines Berufsverbands an alle, die ihre Mitgliedschaft noch nicht verlängert haben: "Mit dem Austritt geben Sie Ihren Eintrag im Expertenverzeichnis und Ihren akkreditierten Presseausweis auf — beides haben Sie sich über Jahre aufgebaut."',
      en: 'A professional association\'s newsletter to members who have not yet renewed: "By leaving, you give up your listing in the expert directory and your accredited press card — both of which you have built up over years."',
    },
    options: [
      { de: 'Verlustaversion', en: 'Loss aversion' },
      { de: 'Verknappung', en: 'Scarcity' },
