...
export const pilotVoiceCloningVishing: Exercise[] = [
  {
    ...
    question: {
      de: 'Welche Technik bildet den Kern der Täuschung gegen den Social-Media-Manager?',
      en: 'Which technique forms the core of the deception targeting the social media manager?',
    },
    scenario: {
  ...
  },
  {
    ...
    options: [
      {
        de: 'Ich veröffentliche nichts, sondern verifiziere über einen zweiten, bekannten Kanal — hinterlegte Nummer des CEO oder sein Büro — und informiere parallel die IT-Sicherheit.',
        en: 'I publish nothing and verify via a second, known channel — the CEO\'s number on file or his office — and inform IT security in parallel.',
      },
      {
        de: 'Ich rufe auf der Nummer zurück, von der die Sprachnachricht kam, lasse mir den Auftrag persönlich bestätigen und dokumentiere ihn für die Freigabe-Akte.',
        en: 'I call back on the number the voice message came from, have the instruction confirmed to me personally, and document it for the sign-off file.',
      },
      {
