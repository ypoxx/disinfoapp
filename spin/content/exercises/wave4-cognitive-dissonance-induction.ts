...
export const w4CognitiveDissonanceInduction: Exercise[] = [
  ...
  },
  {
    ...
    scenario: {
      ...
      en: 'Editorial meeting in the corporate newsroom: the trainee considers the new paywall model anti-customer — the newsroom lead knows this. He nevertheless assigns her the intranet explainer "Why the paywall secures our journalism", including researching the best arguments. As she writes, her judgement inches closer and closer to her own text.',
    },
    options: [
      { de: 'Priming', en: 'Priming' },
      { de: 'Erzeugen kognitiver Dissonanz', en: 'Inducing cognitive dissonance' },
