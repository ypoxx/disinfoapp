...
export const w4ConsentAndPrivacyDarkPatterns: Exercise[] = [
  ...
  },
  {
    ...
    options: [
      ...
      },
      {
        ...
        en: 'I keep the checkbox pre-ticked but remove the partners — as long as only we ourselves use the addresses, a pre-set tick is uncritical.',
      },
      {
  ...
  },
  {
    ...
    scenario: {
      de: 'Nachbereitung der Webinar-Reihe: Der PR-Referent hat sich beim Webinar-Tool zunächst nur mit seiner E-Mail-Adresse registriert. Bei jedem weiteren Login blendet die Plattform einen Dialog ein — „Ihr Profil ist zu 60 % vollständig" — und fragt jeweils ein weiteres Feld ab: Telefonnummer, Position, Unternehmensgröße, Budgetverantwortung. Wofür die Angaben genutzt werden, nennt kein Dialog; der „Überspringen"-Link wird von Mal zu Mal unauffälliger. Zwei Wochen später ruft ein Vertriebler des Plattform-Sponsors an — er kennt Position und Budgetverantwortung des Referenten.',
      en: 'Follow-up on the webinar series: the PR officer initially registered for the webinar tool with nothing but his email address. On every subsequent login the platform shows a dialog — "Your profile is 60% complete" — and asks for one more field each time: phone number, job title, company size, budget responsibility. No dialog ever states what the details will be used for; the "Skip" link gets less conspicuous each round. Two weeks later, a sales rep from the platform\'s sponsor calls — and already knows the officer\'s job title and budget responsibility.',
    },
    options: [
      { de: 'Gamification (Fortschritts-/Vollständigkeitsanzeige)', en: 'Gamification (progress / completeness meter)' },
      { de: 'Consent- und Privacy-Dark-Patterns', en: 'Consent and privacy dark patterns' },
      { de: 'Sludge', en: 'Sludge' },
      { de: 'Subscription Trap / Obstruction (Roach Motel)', en: 'Subscription trap / obstruction (roach motel)' },
    ],
