...
export const wave5aAnaphora: Exercise[] = [
  {
    ...
    scenario: {
      ...
      en: 'Annual shareholders\' meeting of a machinery manufacturer: the CEO closes his outlook to investors by opening every sentence with the same two words: "We invest in our plants. We invest in training. We invest in the next generation of machines." The three sentences follow one another directly, the opening staying identical word for word.',
    },
    options: [
      { de: 'Anapher', en: 'Anaphora' },
      { de: 'Epipher', en: 'Epistrophe' },
      { de: 'Anadiplose', en: 'Anadiplosis' },
      { de: 'Parallelismus', en: 'Parallelism' },
    ],
    correctAnswers: [0],
    explanation: {
      de: 'Anapher: Das definierende Merkmal ist der Wort-für-Wort gleiche Auftakt mehrerer direkt aufeinanderfolgender Sätze („Wir investieren in…") — die Wiederholung steht am Satzanfang. So setzt du die Figur professionell ein: Ein paralleler Satzanfang gibt einer ohnehin tragfähigen Kernbotschaft Rhythmus und Struktur; als Stilmittel ist das legitim, solange jede Zeile eine belegbare Aussage trägt. Daran erkennst du sie und so klärst du Verwechslungen: Achte auf den identischen Auftakt im engen Satzverbund und prüfe, ob der Dreiklang eine Aussage bündelt oder eine dünne Begründung überdeckt. Die drei Distraktoren sind echte Nachbarfiguren, die nur bei anderer Stellung zuträfen: Epipher wäre es, wenn sich der gleiche Wortlaut am Satzende wiederholte — das Spiegelbild der Anapher. Anadiplose läge vor, wenn das letzte Wort eines Satzes den nächsten eröffnete (Verkettung), nicht ein durchgehend gleicher Auftakt. Parallelismus meint den gleichen Satzbau bei frei wechselnden Wörtern — hier sind die Anfangswörter aber wörtlich identisch, was über bloße Strukturgleichheit hinausgeht und die Figur eindeutig zur Anapher macht.',
      en: 'Anaphora: the defining feature is the word-for-word identical opening of several directly consecutive sentences ("We invest in…") — the repetition sits at the start of the sentence. Using it professionally: a parallel sentence opening gives an already sound core message cadence and structure; as a stylistic device it is legitimate, as long as each line carries a claim you can back. Recognising it and clearing up mix-ups: watch for the identical opening in a tight run of sentences and check whether the triad bundles a statement or papers over a thin argument. The three distractors are genuine neighbouring figures that would only apply with a different placement: epistrophe would be the case if the same wording recurred at the end of the sentences — anaphora\'s mirror image. Anadiplosis would mean the last word of one sentence opens the next (chaining), not one consistently repeated opening. Parallelism denotes the same sentence structure with freely varying words — but here the opening words are literally identical, which goes beyond mere structural symmetry and makes the figure unambiguously anaphora.',
    },
    points: 10,
    primaryTechniqueId: 'anaphora',
    relatedTechniques: ['anaphora', 'repetition'],
  },
  {
  ...
  },
  {
    ...
    correctAnswers: [0],
    explanation: {
      de: 'Anapher: Kennzeichen ist der identische Wortlaut am Satzanfang mehrerer aufeinanderfolgender Sätze („Deshalb bleiben wir…"). So nutzt du sie professionell: Ein wiederkehrender Auftakt gibt einem Aufruf eine klare Gliederung und lässt die einzelnen Zeilen als eine Haltung auftreten — als Stilmittel ist das sauber, solange jede Zeile eine tragfähige Aussage transportiert. Daran erkennst du sie: Wo sich der Zeilenanfang Wort für Wort wiederholt und ein Dreiklang entsteht, liegt eine Anapher vor; frag dich dann, ob der Rhythmus eine Aussage bündelt oder eine dünne Begründung ersetzt. Alliteration meint dagegen den gleichen Anfangs-Laut aufeinanderfolgender Wörter („bleiben — Bühne — Botschaft"), nicht den gleichen Wortlaut am Satzanfang. Epipher wäre das Spiegelbild: derselbe Wortlaut am Satzende statt am Satzanfang — hier wiederholt sich der Auftakt „Deshalb bleiben wir" jedoch am Zeilenanfang, nicht am Zeilenende. Loaded Language wäre der Einsatz emotional aufgeladener Wörter zur Wertung — die Wortwahl hier ist neutral, verstärkt wird allein über den parallelen Satzbau.',
      en: 'Anaphora: its hallmark is the identical wording at the start of several consecutive sentences ("That is why we stay…"). Using it professionally: a recurring opening gives an appeal a clear structure and lets the individual lines read as one stance — a clean stylistic device, as long as each line carries a sound claim. Recognising it: where the start of the line repeats word for word and a triad forms, you are looking at anaphora; then ask whether the rhythm bundles a statement or replaces a thin argument. Alliteration, by contrast, means the same initial sound in consecutive words ("stage — story — statement"), not the same wording at the start of a sentence. Epistrophe would be the mirror image: the same wording at the end of the sentence rather than at the start — here, though, the opening "That is why we stay" recurs at the beginning of the line, not the end. Loaded language would be the use of emotionally charged words to colour a judgment — the word choice here is neutral, the intensification comes solely from the parallel sentence structure.',
    },
    points: 10,
    primaryTechniqueId: 'anaphora',
