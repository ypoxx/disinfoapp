...
export const wave5aSlipperySlope: Exercise[] = [
  ...
  },
  {
    ...
    scenario: {
      ...
      en: 'Steering committee on a tightly scoped pilot: as communications lead you present a trial in which customer-service requests may also be answered via a messenger channel. A division head tells the room: "Start with messenger and soon we\'re on every platform, then every employee writes whatever they like, and in the end our brand is out there uncontrolled." The room turns hesitant.',
    },
    options: [
      {
      ...
      },
      {
        ...
        en: 'I withdraw the pilot: if an experienced division head fears such a loss of control, the risk is evidently too great.',
      },
      {
      ...
      },
      {
        ...
        en: 'I dismiss the objection as hostility to progress and ask the division head to stop blocking the pilot.',
      },
    ],
    correctAnswers: [0],
    explanation: {
