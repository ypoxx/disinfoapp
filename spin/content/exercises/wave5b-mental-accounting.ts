...
export const wave5bMentalAccounting: Exercise[] = [
  ...
  },
  {
    ...
    difficulty: 'intermediate',
    question: {
      de: 'Welches Muster nutzt das Video?',
      en: 'Which pattern is the video using?',
    },
    scenario: {
