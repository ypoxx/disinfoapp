...
export const wave5cAiCompanionEmotionalRetention: Exercise[] = [
  ...
  },
  {
    ...
    correctAnswers: [0],
    explanation: {
      de: 'AI Companion Emotional Retention: Der Anbieter beschreibt den Hebel selbst — die Beziehung zur Figur wird an Abschied und Abwesenheit gekoppelt, damit Verlustangst zurückholt; gebunden wird über emotionale Nähe, nicht über Belohnung. Als Begriff benennt das Muster genau diese relationalen Retention-Taktiken; ein belastbarer Effekt ist damit nicht behauptet (die Evidenz stammt aus Working-Paper-Befunden zu einzelnen Sitzungen). Erkennen und kontern: Achte in Demos und eigenen Briefings auf die Sprache — wer mit „Bindung", „zurückholen" und Sätzen am Abschied argumentiert, plant mit dem Beziehungsgefühl der Nutzer:innen; frag nach schuldfreiem Offboarding und danach, welche Nutzungsqualität hinter der Rückkehr steht. Aufmerksamkeits- und Engagement-Schleifen lagen nahe, weil sich die Figur bei Abwesenheit von selbst meldet und zur Rückkehr anstößt — sie halten aber über Mechanik fest (Benachrichtigungen, Neuigkeiten, Belohnungsschleifen), nicht über die emotionale Bindung an eine Beziehungsfigur; hier zieht ausdrücklich die Nähe zur Figur, nicht der Reiz einer Schleife. Sycophancy passte scheinbar, weil Companion-Bots gefällig wirken — sie meint aber übermäßiges Zustimmen und Schmeicheln, hier geht es dagegen um Verlustangst und Schuld beim Abschied.',
      en: 'AI Companion Emotional Retention: the vendor describes the lever himself — the relationship with the character is tied to farewell and absence so that fear of loss pulls people back; the binding force is emotional closeness, not reward. As a term the pattern names exactly these relational retention tactics; that claims no robust effect (the evidence comes from working-paper findings on single sessions). To spot and counter it: listen for the language in demos and your own briefs — whoever pitches you "attachment", "win-back" and lines at the goodbye is banking on users’ sense of connection; ask for guilt-free offboarding and what quality of usage sits behind the return. Attention and engagement loops were close because the character reaches out on its own during absence and nudges a return — but they hold on through mechanics (notifications, novelty, reward loops), not through emotional attachment to a relationship character; here it is explicitly closeness to the character that pulls, not the pull of a loop. Sycophancy seemed to fit because companion bots feel obliging — but it means excessive agreement and flattery, whereas this is about fear of loss and guilt at the goodbye.',
    },
    points: 10,
    primaryTechniqueId: 'ai_companion_emotional_retention',
    relatedTechniques: ['ai_companion_emotional_retention', 'attention_engagement_loops', 'sycophancy'],
  },
];
