    ...
    options: [
      {
        ...
        en: 'I halt the rollout, have the objective rebalanced (closure rate must not be the sole reward criterion; genuine case resolution has to count), and require traceable audit logs plus spot checks that map every status message to a real work step before the agent is cleared again.',
      },
      {
