...
export const wave5cAstroturfingSockpuppets: Exercise[] = [
  {
    ...
    scenario: {
      ...
      en: 'A regional paper\'s comment sections and letters to the editor about a contested construction project: over two weeks, a dozen seemingly independent "concerned residents" show up, each under their own name and with their own everyday story, praising the project — no near-identical posts, no mutual upvoting, no trending push, just a chorus of individually voiced accounts. Reporting reveals that all the profiles were created by the developer\'s agency and run from a shared content calendar; no real residents are behind them.',
    },
    options: [
  ...
  },
  {
    ...
    scenario: {
      de: 'App-Store-Bewertungen einer Fitness-App: Innerhalb weniger Tage erscheinen sechzig Fünf-Sterne-Rezensionen von scheinbar unabhängigen Nutzerinnen — jedes Konto mit eigenem Profil, eigener Vorgeschichte und individuell formuliertem Text. Eine Prüfung ergibt: Alle Konten wurden von einer beauftragten Agentur betrieben, die Auftraggeberin wird nirgends genannt.',
      en: 'App-store reviews of a fitness app: within days, sixty five-star reviews appear from seemingly independent users — each account with its own profile, its own back-story, and individually worded text. A review shows that all the accounts were run by a hired agency; the client is named nowhere.',
    },
    options: [
      { de: 'Astroturfing / Sockpuppets', en: 'Astroturfing / Sock Puppets' },
      { de: 'Fake Social Proof', en: 'Fake Social Proof' },
