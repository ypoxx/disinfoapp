...
export const wave5cConfirmshaming: Exercise[] = [
  ...
  },
  {
    ...
    scenario: {
      de: 'Kündigungsstrecke im Abo-Center eines Streamingdienstes: Um das Abo endgültig zu beenden, muss die Nutzerin auf die Schaltfläche „Nein, ich brauche keine gute Unterhaltung" tippen; die Alternative daneben lautet „Weiter genießen".',
      en: 'Cancellation flow in the account centre of a streaming service: to end the subscription for good, the user has to tap the button "No, I don\'t need good entertainment"; the alternative next to it reads "Keep enjoying".',
    },
    options: [
      { de: 'Confirmshaming', en: 'Confirmshaming' },
      { de: 'Verlustaversion', en: 'Loss aversion' },
    ...
    correctAnswers: [0],
    explanation: {
      de: 'Confirmshaming: Der Bestätigungs-Button zum Kündigen ist als Selbstvorwurf formuliert („Nein, ich brauche keine gute Unterhaltung"), die Alternative bleibt positiv besetzt („Weiter genießen") — die Scham steckt im Wortlaut der Wahl selbst, nicht in einem Argument oder in der Struktur der Strecke. Der Hebel wirkt, weil niemand die eigene Entscheidung mit einem Klick als Charakterschwäche quittieren will. Legitim einsetzen: Du darfst den Verbleib-Button einladend gestalten und den Wert des Abos benennen — professionell bleibt es, solange die Kündigung sachlich beschriftet ist („Abo kündigen"). Erkennen und kontern: Lies die Kündigen-Schaltfläche wörtlich — wenn sie dir eine schlechte Eigenschaft oder einen Makel in den Mund legt statt neutral „kündigen" zu sagen, ist es Confirmshaming; lass dich davon nicht ausbremsen und tippe trotzdem. Verlustaversion wirkt hier plausibel, weil mit dem Kündigen der Zugang zu den Lieblingsserien wegfällt — sie würde das Angebot selbst als drohenden Verlust rahmen („dir entgehen deine Serien"). Auf dem Button steht aber kein Verlust, sondern ein Selbstvorwurf, der dir eine Eigenschaft zuschreibt („ich brauche keine gute Unterhaltung"); dieser Scham-Hebel im Wortlaut ist Confirmshaming, nicht Verlustaversion. Abo-Falle / Obstruction (Roach Motel) liegt nahe, weil es um eine Kündigungsstrecke geht — sie erschwert das Kündigen aber über Struktur und Hürden (versteckte Schaltflächen, Extra-Schritte, Warteschleifen), während hier ein einziger klarer Button steht, dessen beschämender Wortlaut allein den Ausschlag gibt.',
      en: 'Confirmshaming: the confirm-cancel button is phrased as a self-accusation ("No, I don\'t need good entertainment"), while the alternative stays positive ("Keep enjoying") — the shame is in the wording of the choice itself, not in an argument or in the structure of the flow. The lever works because nobody wants to sign off their own decision as a character flaw with a single click. Used legitimately: you may make the stay-button inviting and name the subscription\'s value — it stays professional as long as the cancel option is labelled plainly ("Cancel subscription"). To spot and counter it: read the cancel button literally — if it frames your choice as a personal failing rather than plainly saying "cancel", it is confirmshaming; do not let it slow you down, and tap it anyway. Loss aversion looks plausible here because cancelling means losing access to the favourite shows — it would frame the offer itself as an impending loss ("you\'ll miss your shows"). But the button carries no loss; it carries a self-accusation that pins a trait on you ("I don\'t need good entertainment") — that shame lever in the wording is confirmshaming, not loss aversion. Subscription trap / obstruction (Roach Motel) looks close because this is a cancellation flow — but it obstructs cancelling through structure and hurdles (hidden controls, extra steps, hold loops), whereas here there is a single clear button whose shaming wording alone does the work.',
    },
    points: 10,
    primaryTechniqueId: 'confirmshaming',
