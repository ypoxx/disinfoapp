  ...
  },
  {
    ...
    options: [
      ...
      },
      {
        ...
        en: 'I book the empathetic, per-objection-tailored answering style as a strength for customer rapport and recommend approval with the single condition of visually shortening the replies so they feel less overwhelming — the behaviour itself stays.',
      },
    ],
    correctAnswers: [0],
    explanation: {
