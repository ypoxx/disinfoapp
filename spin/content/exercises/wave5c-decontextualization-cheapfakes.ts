...
export const wave5cDecontextualizationCheapfakes: Exercise[] = [
    ...
    options: [
      {
        ...
        en: 'I document the real context: I promptly state the capture date and origin of the original, link the traceable first source, and use a reverse image search to show the motif is old and unrelated — factually, without needlessly repeating the false claim.',
      },
      {
  ...
  },
  {
    ...
    scenario: {
      ...
      en: 'A party\'s monitoring team reviews a viral clip: a genuine interview video of the lead candidate has been noticeably slowed down, so her speech sounds slurred and dazed. The footage is technically untouched — only the throttled speed creates the impression.',
    },
    options: [
      {
