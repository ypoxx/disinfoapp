...
export const wave5cDecontextualizationCheapfakes: Exercise[] = [
  ...
  },
  {
    ...
    scenario: {
      de: 'Monitoring-Team eines Unternehmens sichtet einen viralen Clip: Ein echtes Interviewvideo der Vorstandsvorsitzenden ist merklich verlangsamt, sodass ihre Sprache verwaschen und benommen klingt. Die Bildspur ist technisch unangetastet — nur das gedrosselte Tempo erzeugt den Eindruck.',
      en: 'A company\'s monitoring team reviews a viral clip: a genuine interview video of the CEO has been noticeably slowed down, so her speech sounds slurred and dazed. The footage is technically untouched — only the slowed-down playback creates the impression.',
    },
    options: [
      {
