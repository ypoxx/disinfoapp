...
export const wave5cFakeSocialProof: Exercise[] = [
  {
    ...
    options: [
      { de: 'Fake Social Proof (Falscher sozialer Beweis)', en: 'Fake social proof' },
  ...
  },
  {
    ...
    options: [
      {
        de: 'Fake Social Proof (Falscher sozialer Beweis) — fabrizierte Popularitätssignale ohne reale Grundlage, im Interface platziert',
      ...
      {
        de: 'Social Proof (Echter sozialer Beweis) — reale Belege, dass viele andere das Produkt nutzen und schätzen',
    ...
    correctAnswers: [0],
    explanation: {
      de: 'Fake Social Proof: Durchschnitt und Nutzerzahl sind fabrizierte Popularitätssignale, prominent im Interface platziert, obwohl kaum echte Bewertungen vorliegen. Der Hebel ist Social Proof über scheinbare Masse und Qualität. Erkennen und kontern: Vergleiche die behauptete Nutzerzahl mit der sichtbaren Zahl echter Bewertungen und dem Alter des Angebots — klaffen sie auseinander, ist die Angabe gesetzt; verlange die Rohdaten. Legitim ist dieselbe Anzeige nur mit real erhobenen, nachprüfbaren Werten. Astroturfing läge vor, wenn die Bewertungen von verdeckt gesteuerten Schein-Personen geschrieben wären — hier sind es keine erfundenen Personen, sondern erfundene Aggregatzahlen. Echter sozialer Beweis bräuchte reale Belege statt frei gesetzter Werte. Getarnte Werbung meint eine als redaktionell verkleidete bezahlte Botschaft — hier geht es nicht um ein getarntes Format, sondern um fabrizierte Popularität.',
