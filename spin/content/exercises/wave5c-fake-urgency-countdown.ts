...
export const wave5cFakeUrgencyCountdown: Exercise[] = [
  {
    ...
    scenario: {
      de: 'Als UX-Reviewer prüfst du die Buchungsseite eines Reiseportals: Neben jedem Hotel blinkt ein roter Countdown „Dieser Preis endet in 04:59". Lädst du die Seite neu, steht die Uhr wieder bei 04:59 — ein tatsächliches Preisende hinterlegt das System nirgends, der Preis ist auch am nächsten Tag derselbe.',
      en: 'As a UX reviewer you audit the booking page of a travel portal: next to every hotel a red countdown flashes, "This price ends in 04:59". Reload the page and the clock is back at 04:59 — the system stores no actual price cut-off anywhere, and the price is the same the next day.',
    },
    options: [
  ...
  },
  {
    ...
    options: [
      ...
      {
        de: 'Ein Flash-Sale-Countdown „Aktion endet in 03:12:44", der zum hinterlegten Enddatum tatsächlich abläuft und danach nicht neu startet.',
        en: 'A flash-sale countdown "Sale ends in 03:12:44" that actually lapses at the stored end date and does not restart afterwards.',
      },
      {
        de: 'Ein Hinweis „Innerhalb 2 Std bestellen für Lieferung morgen", der an die reale Abholzeit des Versanddienstleisters gekoppelt ist.',
        en: 'A note "Order within 2 hrs for delivery tomorrow", tied to the carrier\'s real pickup cut-off.',
      },
      {
    ...
    correctAnswers: [0],
    explanation: {
      de: 'Das Fake-Urgency-Signal ist der Reservierungs-Countdown (0): Der Mechanismus ist erfundener Zeitdruck — die Uhr suggeriert, der Warenkorb verfalle, obwohl sie nach Null einfach neu startet und nichts verloren geht. Legitim wäre Dringlichkeit nur mit einer realen Frist (etwa einer echten Reservierungslogik, die abläuft) oder einem realen Bestand. So erkennst du es: Warte den Ablauf ab oder lade neu — passiert nichts oder springt die Uhr zurück, ist der Druck vorgetäuscht. Die falschen Optionen sind echte Grenzfälle zwischen vorgetäuschtem und gerechtfertigtem Zeitdruck: Der Flash-Sale-Countdown (1) läuft zum hinterlegten Enddatum tatsächlich ab und startet nicht neu — belegbare, für alle gleiche Dringlichkeit; der Versand-Cutoff (2) ist an die reale Abholzeit des Dienstleisters gekoppelt, also ein ehrlicher Stichtag statt einer Inszenierung; und die Lagerangabe (3) ist echte Verknappung — sie spiegelt den tatsächlichen Bestand und ist damit gerade kein Dark Pattern, sondern die legitime Schwester der Fake Urgency.',
      en: 'The fake-urgency signal is the reservation countdown (0): the mechanism is invented time pressure — the clock implies the cart will expire, yet it simply restarts after zero and nothing is lost. Urgency would be legitimate only with a real deadline (say a genuine reservation timeout that actually lapses) or real stock. How to spot it: let it run out or reload — if nothing happens or the clock jumps back, the pressure is fabricated. The wrong options are genuine borderline cases between fabricated and warranted time pressure: the flash-sale countdown (1) actually lapses at the stored end date and does not restart — provable urgency that applies to everyone; the shipping cut-off (2) is tied to the carrier\'s real pickup time, an honest deadline rather than a staged one; and the stock note (3) is genuine scarcity — it reflects real inventory and is therefore not a dark pattern but the legitimate sibling of fake urgency.',
    },
    points: 10,
    primaryTechniqueId: 'fake_urgency_countdown',
