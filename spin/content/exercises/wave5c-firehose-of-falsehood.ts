...
export const wave5cFirehoseOfFalsehood: Exercise[] = [
  ...
  },
  {
    ...
    scenario: {
      de: 'Social-Media-Analyse rund um eine anstehende Volksabstimmung: Als Analyst siehst du, wie zum selben Ereignis binnen Stunden fünf, sechs miteinander unvereinbare Erklärungen gleichzeitig über Blogs, Messenger-Gruppen und Kurzvideos ausgespielt werden — jede in hohem Tempo, keine wird aufgelöst, und in der Summe bleibt vor allem der Eindruck, dass sich ohnehin nichts mehr sicher sagen lässt.',
      en: 'Social-media analysis around an upcoming referendum: as an analyst you watch five or six mutually incompatible explanations of the same event get pushed out simultaneously within hours across blogs, messenger groups and short videos — each at high speed, none resolved, and the sum leaves mainly the impression that nothing can be said for certain anyway.',
    },
    options: [
      { de: 'Firehose of Falsehood', en: 'Firehose of Falsehood' },
