...
export const wave5cHistoricalNarrativeControl: Exercise[] = [
  {
    ...
    options: [
      ...
      { de: 'Cherry-Picking (selektive Auslassung)', en: 'Cherry-picking' },
    ],
    correctAnswers: [0],
    explanation: {
