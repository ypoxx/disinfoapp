...
export const wave5cOvertonWindowShifting: Exercise[] = [
  ...
  },
  {
    ...
    scenario: {
      ...
      en: 'You lead communications for an association. A board member proposes drip-feeding a currently unwinnable maximalist demand over months across op-eds, panels and social posts — first as a taboo-break, then ever more casually — so that it eventually counts as a normal negotiating position. How do you handle it?',
    },
    options: [
      {
      ...
      },
      {
        ...
        en: 'I run the campaign as proposed — the more often and more casually the demand appears, the more self-evident it becomes; that the sayable can be shifted this reliably is an established communications playbook.',
      },
      {
