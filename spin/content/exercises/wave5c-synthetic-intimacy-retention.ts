...
export const wave5cSyntheticIntimacyRetention: Exercise[] = [
  ...
  },
  {
    ...
    options: [
      ...
      {
        de: 'Ich stufe es als Coercive Control ein und melde es der Polizei als häusliche Gewalt; intern sehe ich keinen Handlungsbedarf am Produkt.',
        en: 'I classify it as coercive control and report it to the police as domestic abuse; internally I see no need to change the product.',
      },
      {
