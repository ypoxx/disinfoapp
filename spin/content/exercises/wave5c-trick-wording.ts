...
export const wave5cTrickWording: Exercise[] = [
    ...
    options: [
      {
        ...
        en: 'I replace the line with a single affirmative statement ("Yes, send me the newsletter") and an unchecked box, and set a styleguide rule that consent copy carries no double negatives and no pre-selection.',
      },
      {
  ...
  },
  {
    ...
    options: [
      {
        de: '… die verdrehte Bau- und Verneinungsstruktur eines Ja/Nein-Entscheidungssatzes — … ein einzelnes Wort, das mitten im Argument die Bedeutung wechselt',
        en: '… the tangled structure and negation of a yes/no decision sentence — … a single word that shifts meaning mid-argument',
      },
      {
        de: '… ein einzelnes Wort, das mitten im Argument die Bedeutung wechselt — … die verdrehte Bau- und Verneinungsstruktur eines Ja/Nein-Entscheidungssatzes',
        en: '… a single word that shifts meaning mid-argument — … the tangled structure and negation of a yes/no decision sentence',
      },
      {
