/* Types from ../types are available for future use */

/**
 * Quiz question option with localized text and correctness flag.
 * This is the original TechniqueQuestion format from the quiz system.
 */
export interface TechniqueQuizOption {
  id: string;
...
export interface TechniqueQuestion {
  id: string;
  type: 'identification' | 'matching';
  question: { de: string; en: string };
  scenario: { de: string; en: string };
  correctAnswers: string[];
  options: TechniqueQuizOption[];
