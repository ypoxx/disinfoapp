# SPIN Content-Offensive — Validierte Musterübungen

Beleg-Charge für die [Content-Offensive](./content-offensive-plan.md), Phase 2.
16 Übungen für vier bislang unbelegte Techniken (**priming, reciprocity, dark_patterns, nudging**).
Alle vier Chargen haben die adversariale Qualitätsprüfung im ersten Durchgang bestanden (**4/4**):
Single-Answer-Invariante, Reframe von „echt/fake" auf benannte Technik, ethische-Grenze-Erklärung, DE + EN.

Ton wurde vom Product Owner freigegeben. Diese Items dienen als Muster für den Autoren-Loop.
Vor der Aufnahme in den Pool durchlaufen sie noch das Content-Validierungsskript aus Phase 0
(`primaryTechniqueId`, Options-Range, verbotene Strings, ID-Eindeutigkeit).

Interaktive Review-Ansicht (im Session-Stil, DE/EN-Umschalter):
https://claude.ai/code/artifact/b5bec878-9742-45a6-8718-9da4c0e330e6
